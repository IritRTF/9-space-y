export class Client {
   ...
   * */
  async getUser() {
    let response = await fetch('https://localhost:3000/api/getUser', {method: 'GET'});
   ...
   * */
  async logoutUser() {
    return await fetch('https://localhost:3000/api/logout', {method: 'POST'});
  }
   ...
   * */
  async getInfo() {
    return await fetch('https://api.spacexdata.com/v3/info').then((res) => res.json());
  }
   ...
   * */
  async getHistory() {
    return await fetch('https://api.spacexdata.com/v3/history').then((res) => res.json());
  }
  ...
  async getHistoryEvent(id) {
    return await fetch(`https://api.spacexdata.com/v3/history/${id}`).then((res) => res.json());
  }
   ...
   * */
  async getRockets() {
    return await fetch("https://api.spacexdata.com/v3/rockets").then((res) => res.json());
  }
   ...
   * */
  async getRocket(id) {
    return await fetch(`https://api.spacexdata.com/v3/rockets/${id}`).then((res) => res.json());
  }
   ...
   * */
  async getRoadster() {
    return await fetch(`https://api.spacexdata.com/v3/roadster`).then((res) => res.json());
  }
